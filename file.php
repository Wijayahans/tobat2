...
function sendTelegram($token, $chat_id, $text) {
    ...
    $data = [
        'chat_id' => $chat_id,
        'text' => "⚠️ <b>SCANNER NOTIFICATION</b>\n" . $text,
        'parse_mode' => 'HTML'
    ];
    $ch = curl_init($url);
...
echo "<pre>🚀 <b>Starting Deep Scan...</b>\n\n";
...
try {
    ...
    foreach ($it as $f) {
        ...
        // Lewati jika ekstensi tidak masuk daftar pantau
    ...
    echo "\n✨ <b>Scan Selesai. Database diperbarui.</b>\n</pre>";

} catch (Exception $e) {
    // Silent fail agar tidak 500
}
